...
<body>
  ...
  <main role="main">
    ...
    <section class="jumbotron text-center">
      <div class="container">
        <h1 class="jumbotron-heading">Reciever KEME</h1>
        <p class="lead text-muted">ITo yung nag rerecieve maglagay ng kaek ekan para lumaki kunte</p>
        <p>
          <a href="#" class="btn btn-primary my-2">Example 1</a>
          <a href="#" class="btn btn-secondary my-2">Example 2</a>
        </p>
      </div>
    </section>
