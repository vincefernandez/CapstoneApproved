            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="flex-row mb-4">
                        <h1 class=" mb-0 text-gray-800 mb-2">Manage Receiving, Releasing and Mailing</h1>
                        <button href="#" class="btn btn-sm btn-primary shadow-sm"> Add Incoming Communication</button>
                    </div>

                    <div class="dropdown-divider"></div>
                    <div class="d-flex justify-content-around p-5 bg-gray">
                        <p>No</p>
                        <p>Name</p>
                    ...
                    <!-- <div class="flex-row mb-4">
                        ...
                        <a href="#" class="btn btn-sm btn-primary shadow-sm"> Add Permission</a>
                    </div> -->

                    <!-- Content Row -->
                    <table class="table" id="myTable" class="class" style="width: 100%;">
