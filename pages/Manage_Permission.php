...
include('../templates/headerPages.html');
?>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="../assets/images/releasing.png">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="flex-row mb-4">
                        <h1 class="h3 mb-0 text-gray-800">User Permission</h1>
                    ...
                    <br>
                    <div class="flex-row mb-4">
                        <h1 class="h5 mb-0 text-gray-800">Permission Name</h1>
                        <div class="dropdown-divider"></div>
                        <input type="text" class="form-class text-gray bg-light border-white w-100" placeholder="Enter Group Name">

                    </div>
                    <div class="dropdown-divider"></div>
                    <!-- Content Row -->
                    <table class="table" class="class" style="width: 100%;">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td>Members</td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td>Appointment and Clearance</td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td>Certification, Authentication and Verification</td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
                                <td><input type="checkbox" class="form-class"></td>
